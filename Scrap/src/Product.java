public class Product {
    ...
    private String productNavigationOne;
    private String productNavigationTwo;
    private String productNavigationThree;
    private String productNavigationFour;
    private String productNavigationFive;
    ...
    public String getProductNavigationFive() {
        return productNavigationFive;
    }

    public void setProductNavigationFive(String productNavigationFive) {
        this.productNavigationFive = productNavigationFive;
    }
    ...
    public String toString() {
        return "Product{" +
                ...
                ", productNavigationFive='" + productNavigationFive + '\'' +
                '}';
    }
}
